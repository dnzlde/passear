...
void main() {
  ...
  group('LocalTtsService', () {
    ...
    test('should handle multiple speak calls', () async {
      final ttsService = LocalTtsService();
      await expectLater(ttsService.speak('First message'), completes);
      await expectLater(ttsService.speak('Second message'), completes);
    });
    ...
    test('should handle speak after stop', () async {
      ...
      await expectLater(ttsService.speak('Message after stop'), completes);
    });
  });
}
