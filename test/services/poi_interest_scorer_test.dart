...
void main() {
  group('PoiInterestScorer', () {
    ...
    test('should categorize museums correctly', () {
      final category = PoiInterestScorer.determineCategory(
        'Tel Aviv Museum of Art',
      );
    ...
    test('should determine high interest level for high scores', () {
      final level = PoiInterestScorer.determineInterestLevel(
        45.0,
        PoiCategory.generic,
      );
    ...
    test('should cap scores at maximum value', () {
      ...
      final score = PoiInterestScorer.calculateScore(
        'Historic Cathedral Museum Palace',
        veryLongDesc,
      );
    ...
    test(
      'should achieve high interest level only through truly high scores',
      () {
        // Only POIs with very high adjusted scores should get high interest
        final highMuseumLevel = PoiInterestScorer.determineInterestLevel(
          30.0,
          PoiCategory.museum,
        );
        final veryHighGenericLevel = PoiInterestScorer.determineInterestLevel(
          55.0,
          PoiCategory.generic,
        );
    ...
    test('should use category as score modifier not absolute override', () {
      ...
      final lowGenericLevel = PoiInterestScorer.determineInterestLevel(
        15.0,
        PoiCategory.generic,
      );
